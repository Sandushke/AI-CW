...
def DFS(start_row, start_col, end_row, end_col):
    ...
    while value < 36:
        ...
        if(left_node == 0 or left_node == 4) and (ycord!=0):
            if([xcord][ycord-1] == 4):
...
# def aStar(start_row, start_col, end_row, end_col):
#     print("")
#     print("A * ALGORITHM")
#     xcord = start_row
#     ycord = start_col
...
#     timeTaken = len(dfs_path)
#     print("")
#     print("Time taken by  * search to find goal node: "+ str(timeTaken)+ " minutes")
#
